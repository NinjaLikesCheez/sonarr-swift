...
public extension SonarrRequest where SonarrResponse == ImportListResource {
	...
	/// Updates tags, root folder, or quality profile for multiple import lists in a single request.
	///
...
public extension SonarrRequest where SonarrResponse == EmptyResponse {
	...
	/// Performs an implementation-defined action for an import list (e.g. fetching a list of Trakt user's lists).
	///
