/// A configured import list (e.g. Trakt, Plex Watchlist) that Sonarr adds series from automatically.
public struct ImportListResource: Equatable, Codable, Sendable {
	...
	/// The implementation backing this import list, e.g. `Trakt`, `PlexImport`.
	...
	/// Whether series from this import list are added to Sonarr automatically.
	public let enableAutomaticAdd: Bool
	/// Whether Sonarr searches for missing episodes of series added from this import list.
	public let searchForMissingEpisodes: Bool
	/// Which episodes are monitored for series added from this import list.
	public let shouldMonitor: MonitorType
	/// Whether newly added items from this import list are monitored.
	public let monitorNewItems: NewItemMonitorType
	/// The root folder series from this import list are added under.
	public let rootFolderPath: String?
	/// The quality profile assigned to series added from this import list.
	public let qualityProfileId: Int
	/// The series type assigned to series added from this import list.
	public let seriesType: SeriesType
	/// Whether a season folder is created for series added from this import list.
	public let seasonFolder: Bool
	/// The category of source this import list pulls series from.
	public let listType: ImportListType
	/// The order in which this import list is processed relative to others.
	public let listOrder: Int
	/// The minimum interval between refreshes of this import list, formatted as a time span.
	...
	///   - implementation: The implementation backing this import list, e.g. `Trakt`, `PlexImport`.
	...
	///   - enableAutomaticAdd: Whether series from this import list are added to Sonarr automatically.
	///   - searchForMissingEpisodes: Whether Sonarr searches for missing episodes of series added from this import
	///   list.
	///   - shouldMonitor: Which episodes are monitored for series added from this import list.
	///   - monitorNewItems: Whether newly added items from this import list are monitored.
	///   - rootFolderPath: The root folder series from this import list are added under.
	///   - qualityProfileId: The quality profile assigned to series added from this import list.
	///   - seriesType: The series type assigned to series added from this import list.
	///   - seasonFolder: Whether a season folder is created for series added from this import list.
	///   - listType: The category of source this import list pulls series from.
	///   - listOrder: The order in which this import list is processed relative to others.
	///   - minRefreshInterval: The minimum interval between refreshes of this import list, formatted as a time span.
	public init(
		id: Int? = nil,
		name: String? = nil,
		fields: [Field]? = nil,
